...
import 'package:dicoding_flutter_1/detail_page.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                        ...
                        child: Stack(
                          children: [
                            ...
                            Padding(
                              ...
                              child: ListTile(
                                title: Text(place.name, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),),
                                subtitle: Text(place.location, style: TextStyle(color: Colors.white),),
                              ),
                            )
                          ],
                        ),
            ...
            Container(
              padding: const EdgeInsets.only(top: 20.0),
              child: Text('Popular Categories', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16),),
            ),
            Container(
              padding: const EdgeInsets.only(top: 20.0),
              child: Row(
